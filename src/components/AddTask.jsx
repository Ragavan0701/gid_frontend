    ...
    <div className="w-full flex justify-center mt-10 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-lg bg-white/70 backdrop-blur-lg shadow-2xl rounded-3xl p-6 sm:p-8 border border-gray-200 hover:shadow-blue-200 transition-all duration-300 ease-in-out">
        ...
        <div className="flex items-center justify-center mb-6">
          <ClipboardPlus className="w-8 h-8 text-blue-600 mr-2" />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <button
              type="submit"
              className="flex-1 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-xl font-semibold shadow-md hover:shadow-lg hover:scale-[1.03] transition-all duration-300 ease-in-out"
            >
              Add Task
            </button>
            <button
