  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex flex-1 justify-center">
        <div
          className={`flex items-center group border rounded-full px-3 py-1 shadow-inner transition-all duration-300 ${
            darkMode
              ? "bg-gray-800 border-gray-700 focus-within:ring-2 focus-within:ring-purple-500/60"
              : "bg-gray-100 border-gray-300 focus-within:ring-2 focus-within:ring-blue-400/60"
          } hover:scale-[1.03] hover:shadow-lg backdrop-blur-md w-full max-w-md`}
        >
          <Search
            className={`w-5 h-5 mr-2 transition-all duration-200 ${
              darkMode
                ? "text-purple-400 group-focus-within:text-purple-500"
          ...
          <input
            ...
            className={`outline-none text-sm w-full bg-transparent placeholder:italic transition-all duration-300 ${
              darkMode
      ...
      <div className="flex items-center gap-3 sm:gap-4 relative">
        ...
        <button
          className={`sm:hidden p-2 rounded-full hover:scale-110 transition-transform ${
            darkMode
      ...
      {showSearch && (
        <div
          className={`absolute top-16 left-4 right-4 flex items-center border rounded-full px-3 py-2 shadow-md transition-all duration-300 ${
            darkMode
